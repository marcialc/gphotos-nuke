...
- Permissions are intentionally narrow: `activeTab`, `scripting`, and host access to `photos.google.com` only. Adding permissions has a real Chrome Web Store review cost — see `extension/README.md`.
